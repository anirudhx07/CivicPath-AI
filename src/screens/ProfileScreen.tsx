    ...
    <div className="screen-shell screen-shell-sm flex-1 flex flex-col">
        <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8 mb-12 sm:mb-16">
            ...
            <div className="min-w-0 w-full">
                <h2 className="text-3xl sm:text-4xl font-serif italic font-bold break-words">{user.name}</h2>
                <p className="text-muted text-xs font-bold mt-2 break-words">{user.email ?? "Guest session"}</p>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-0 border border-border mb-12 sm:mb-16">
